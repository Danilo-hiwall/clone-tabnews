...
export default function Home() {
  ...
  const showSecretMessage = () => {
    ...
    if (isClient) {
      const heartSound = new Audio('https://assets.mixkit.co/sfx/preview/mixkit-heartbeat-fast-958.mp3');
      heartSound.volume = 0.3;
      heartSound.play().catch(e => console.log("Som não pode ser reproduzido"));
    }
  };
      ...
      <style jsx global>{`
        * {
        ...
        .love-letter::before {
          ...
          right: -10px;
          bottom: -10px;
          background: linear-gradient(45deg, #ff4081, #ff79b0, #ff4081, #ff4081);
          z-index: -1;
          filter: blur(20px);
          opacity: 0.3;
        }
        ...
        <div className="love-letter rounded-3xl shadow-2xl p-8 md:p-12 max-w-4xl w-full mx-auto relative overflow-hidden">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-lg text-rose-600 font-semibold">
              <i className="fas fa-star text-yellow-500"></i> May, Você é Única! <i className="fas fa-star text-yellow-500"></i>
            </p>
          </div>
          ...
          <div className="space-y-6">
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-lg text-gray-800 leading-relaxed">
                    Você é a mulher da minha vida. A pessoa que Deus enviou pra mim.<br />
            ...
            <div className="bg-gradient-to-r from-rose-50 to-pink-50 p-6 rounded-2xl border-l-4 border-pink-400 shadow-lg">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-lg text-gray-800 leading-relaxed">
                    Sou muito agradecido a Deus por cuidar tão bem de nós.<br />
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-lg text-gray-800 leading-relaxed">
                    ...
                    Cada abraço seu é meu porto seguro.<br />
            ...
            <div className="bg-gradient-to-br from-pink-200 to-rose-300 p-1 rounded-2xl shadow-xl">
              <div className="bg-white p-8 rounded-2xl text-center">
                ...
                <p className="text-xl text-rose-600 font-semibold mt-2">
                  <i className="fas fa-heart text-red-500"></i> Para Sempre Juntos <i className="fas fa-heart text-red-500"></i>
                </p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-8">
              <div className="bg-pink-100 p-4 rounded-xl text-center shadow-lg hover:scale-105 transition-transform">
                ...
                <p className="text-sm font-semibold text-gray-700">Felicidade</p>
              </div>
              ...
              <div className="bg-orange-100 p-4 rounded-xl text-center shadow-lg hover:scale-105 transition-transform">
                ...
                <p className="text-sm font-semibold text-gray-700">Eternidade</p>
              </div>
            </div>
            ...
            <div className="mt-10 text-center">
              <div className="inline-flex items-center space-x-2 bg-gradient-to-r from-pink-500 to-red-500 text-white px-6 py-3 rounded-full shadow-lg">
                ...
                <span className="text-xl font-bold dancing-script">Nossa História de Amor</span>
                <i className="fas fa-heart text-xl"></i>
              </div>
              <p className="text-lg text-gray-700 mt-6 italic">
                "O amor não se vê com os olhos, mas com o coração."<br />
                - E nosso coração escolheu você, May!
              </p>
            </div>
